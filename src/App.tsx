    ...
    <React.Fragment key={category}>
      ...
      {TABS.filter(t => t.category === category).map((tab) => (
        ...
        >
          ...
          {/* PERBAIKAN: Gunakan tab.label asli secara dinamis, lalu atur agar rata kiri dan mendukung baris ganda */}
          {isSidebarOpen && (
            <span className="font-medium text-sm text-left block w-full leading-snug">
              {tab.label}
            </span>
          )}
